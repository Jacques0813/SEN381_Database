      ...
      <div style={formStyles}>
            ...
            <div 
              ...
              >
                ...
                {editedTicket.dateResponded && (
                  <span>
                    {' '}
                    | <strong>Date Responded:</strong> {editedTicket.dateResponded}
                  </span>
                )}
              </p>
            </div>
            ...
            <div style={{
              ...
              >
                ...
                <select
                  ...
                  style={inputSelectStyles}
                >
                  <option value="Low" style={optionDropdownStyle}>Low</option>
                  <option value="Medium" style={optionDropdownStyle}>Medium</option>
                  <option value="High" style={optionDropdownStyle}>High</option>
                </select>
              </p>
              <p
                style={{
              ...
              >
                ...
                <select
                  ...
                  style={inputSelectStyles}
                >
                  <option value="John" style={optionDropdownStyle}>John</option>
                  <option value="Liam" style={optionDropdownStyle}>Liam</option>
                  <option value="Kim" style={optionDropdownStyle}>Kim</option>
                </select>
              </p>
              <p
                style={{
              ...
              >
                ...
                <select
                  ...
                  style={inputSelectStyles}
                >
                  <option value="Open" style={optionDropdownStyle}>Open</option>
                  <option value="Resolved" style={optionDropdownStyle}>Resolved</option>
                </select>
              </p>
            </div>
        </div>
        ...
        >
          ...
          >
            ...
            <input 
              type="text" 
              value={editedTicket.alternativeNumber}
        ...
        >
          ...
          >
            ...
            <select
              value={editedTicket.paymentDetails.cardType}
              onChange={(e) => handleInputChange(e, 'cardType')}
              style={inputSelectStyles}
            >
              <option value="Credit Card" style={optionDropdownStyle}>Credit Card</option>
              <option value="PayPal" style={optionDropdownStyle}>PayPal</option>
              <option value="MasterCard" style={optionDropdownStyle}>MasterCard</option>
              <option value="Visa" style={optionDropdownStyle}>Visa</option>
            </select>
          </p>
          ...
          >
            ...
            <input 
              type="text"
              value={editedTicket.paymentDetails.cardNumber}
          ...
          >
            ...
            <input 
              type="text"
              value={editedTicket.paymentDetails.expirationDate}
          ...
          >
            ...
            <input 
              type="text"
              value={editedTicket.paymentDetails.cvv}
