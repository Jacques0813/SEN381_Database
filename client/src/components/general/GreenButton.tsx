...
const GreenButton: React.FC<IGreenButton> = ({ buttonText, onClickFunction }) => {
  return (
    <button
      className="group relative h-10 sm:h-12 w-40 sm:w-48 overflow-hidden rounded-2xl bg-green-500 text-lg font-bold text-white"
