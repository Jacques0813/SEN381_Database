...
const GrayButton: React.FC<IGrayButton> = ({ buttonText, onClickFunction }) => {
  return (
    <button
      className="group relative h-10 sm:h-12 w-40 sm:w-48 overflow-hidden rounded-2xl bg-gray-300 text-lg font-bold text-white"
